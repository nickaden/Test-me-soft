...
<head>
    ...
    <script src="js/direct_url.js"></script>
    ...
    <div class="workspace">
        <div class="task">
            ...
            <div class="sign-in-task">
                <h2>Интересно, а можно ли зайти как пользователь, но не вводить логин и пароль?</h2>
                <form method="post" action="start">
                    <input type="hidden" name="action" value="solve_direct_url">
                    <div id="sign-in-form">
                        <div class="input">
                            Логин
                        ...
                        <button id="solve" type="submit">Войти</button>
                            <p class="info" style="color: green">
                                <c:if test="${sessionScope.task.complete==true}">
                                    Подтверждено! Переходите к следующему заданию.
                                </c:if>
                            </p>
                    </div>
                </form>
